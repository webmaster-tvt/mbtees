				...
				<div class="portfolio-box">
					<div class="container clearfix">
								<?php	$event_our_gallery_get_featured_posts 		= new WP_Query(array(
									'posts_per_page'      	=> absint($event_settings['event_total_our_gallery']),
									'post_type'           	=> array('page'),
									'post__in'            	=> $event_our_gallery_list_page,
									'orderby'             	=> 'post__in',
								));
					if($event_settings['event_our_gallery_title'] != ''){ ?>
						<h2 class="widget-title"><?php echo esc_html($event_settings['event_our_gallery_title']);?> </h2>
					<?php } 
					if($event_settings['event_our_gallery_description'] != ''){ ?>
						<p class="box-sub-title"><?php echo esc_html($event_settings['event_our_gallery_description']);?> </p>
					<?php } ?>
