...
if(!class_exists('Event_Plus_Features')){
	class Event_Customize_upgrade extends WP_Customize_Control {
		public function render_content() { ?>
			<a title="<?php esc_attr_e( 'Review Event', 'event' ); ?>" href="<?php echo esc_url( 'https://wordpress.org/support/view/theme-reviews/event/' ); ?>" target="_blank" id="about_event">
			<?php esc_html_e( 'Review Event', 'event' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'https://themefreesia.com/theme-instruction/event/' ); ?>" title="<?php esc_attr_e( 'Theme Instructions', 'event' ); ?>" target="_blank" id="about_event">
			<?php esc_html_e( 'Theme Instructions', 'event' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'https://tickets.themefreesia.com/' ); ?>" title="<?php esc_attr_e( 'Support Ticket', 'event' ); ?>" target="_blank" id="about_event">
